    ...
    <section id="home" ref={heroRef} className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[var(--color-brand-dark)] pt-28 pb-16 md:pt-32 md:pb-24">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10 flex-grow flex flex-col justify-center">
        <div className="max-w-3xl" ref={contentRef}>
          {/* Eyebrow */}
          <div className="inline-block px-3 py-1 mb-4 md:mb-5 border border-[var(--color-brand-accent)] text-[var(--color-brand-accent)] text-xs font-semibold tracking-widest uppercase bg-[var(--color-brand-dark)]/50 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <a 
              href="#contact" 
              className="bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-accent)] text-white px-6 md:px-7 py-3 text-center font-medium transition-colors duration-300 rounded-sm"
            >
              {siteData.hero.primaryCTA}
            </a>
            <a 
              href="#services" 
              className="bg-transparent border border-white/30 text-white hover:bg-white hover:text-[var(--color-brand-dark)] px-6 md:px-7 py-3 text-center font-medium transition-colors duration-300 rounded-sm"
            >
